...
INSERT INTO airing_entity (id, movie_id, type, time) VALUES 
    -- movie 1:
    (1, 1, 0, DATEADD(HOUR, 0, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    (2, 1, 1, DATEADD(HOUR, 1, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    (3, 1, 2, DATEADD(HOUR, 2, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    -- movie 2:
    (4, 2, 0, DATEADD(HOUR, 0, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    (5, 2, 1, DATEADD(HOUR, 1, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    (6, 2, 2, DATEADD(HOUR, 2, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    -- movie 3:
    (7, 3, 0, DATEADD(HOUR, 0, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    (8, 3, 1, DATEADD(HOUR, 1, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    (9, 3, 2, DATEADD(HOUR, 2, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    -- movie 4
    (10, 4, 0, DATEADD(HOUR, 0, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    (11, 4, 1, DATEADD(HOUR, 1, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    (12, 4, 2, DATEADD(HOUR, 2, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    -- movie 5
    (13, 5, 0, DATEADD(HOUR, 0, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    (14, 5, 1, DATEADD(HOUR, 1, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
    (15, 5, 2, DATEADD(HOUR, 2, DATEADD(DAY, 1, CURRENT_TIMESTAMP()))),
